...
import { Fraud } from '@/constants/mock-api-fraud';

// Message sets for different fraud cases
...
// Hardcoded case logs
// Case logs for different fraud cases
const fraudCaseLogs = {
  1: [
    {
      id: 1,
      ...
      details: 'Fraud case automatically created.',
  ...
  if (!initialData) {
    return (
      <div className='flex min-h-[400px] items-center justify-center'>
        <p className='text-gray-400'>No fraud details found.</p>
      </div>
    );
  }

  // Get the appropriate messages and case logs based on the fraud ID
  const messages =
    conversationMessages[initialData.id as keyof typeof conversationMessages] ||
    [];
  const caseLogs =
    fraudCaseLogs[initialData.id as keyof typeof fraudCaseLogs] || [];
          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-3 gap-4'>
              <div className='rounded-lg bg-gray-800 p-4'>
                <p className='mb-1 text-sm text-gray-400'>Fraud ID</p>
